...
Pod::Spec.new do |s|
  ...
  s.name         = "TBJudgeBankNameWithNumber"
  s.version      = "0.0.1"
  s.summary      = "1"
  ...
  s.homepage     = "https://github.com/james1896/TBJudgeBankNameWithNumber"
  ...
  s.source       = { :git => "https://github.com/james1896/TBJudgeBankNameWithNumber.git", :tag => s.version, :submodules => true }
